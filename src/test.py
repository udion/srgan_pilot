...
try:
	os.makedirs('udion_output/high_res_fake')
	os.makedirs('udion_output/high_res_real')
	os.makedirs('udion_output/low_res')
except OSError:
	pass
...
for i, data in enumerate(dataloader):
	...
	for j in range(opt.batchSize):
		save_image(unnormalize(high_res_real.data[j]), 'udion_output/high_res_real/' + str(i*opt.batchSize + j) + '.png')
		save_image(unnormalize(high_res_fake.data[j]), 'udion_output/high_res_fake/' + str(i*opt.batchSize + j) + '.png')
		save_image(unnormalize(low_res[j]), 'udion_output/low_res/' + str(i*opt.batchSize + j) + '.png')
